...
class RecipeCard extends HTMLElement {
  ...
  constructor() {
    ...
    var elementA = document.createElement('article');
  ...
  time {
    ...
    shadowEl.append(elementA);
    shadowEl.append(elementS);
  }

  /**
   * Called when the .data property is set on this element.this
   *
   * For Example:
  ...
  set data(data) {
    ...
    // let article = document.getElementsByTagName(RecipeCard.elementA);
    ...
    if (data.rating == 5){
      var ratingImg = './assets/images/icons/5-star.svg';
    }
