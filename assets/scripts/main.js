...
function addRecipesToDocument(recipes) {
  ...
  let store = getRecipesFromStorage();
...
function initFormHandler() {
  ...
  let cardElement = document.createElement('recipe-card');
  ...
  //recipeArray.push(cardElement);
  saveRecipesToStorage(getRecipesFromStorage().concat(recipeObject));
  });
